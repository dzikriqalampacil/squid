            ...
            <HStack align={'flex-start'} w='full' px='12%' justify={{ base: 'center', md: 'space-between' }} >
                <VStack align={'flex-start'}>
                    ...
                    <VStack spacing={'16px'} w='full'>
                        ...
                        <Input onChange={e => setEmail(e.target.value)} value={email} placeholder='Your Email' size='md' bg='#18181C' color='#9E9E9E' border={'none'} _placeholder={{ color: '#9E9E9E' }} />
                        ...
                        <Input onChange={e => setRepeatPassword(e.target.value)} value={repeatPassword} placeholder='Repeat Password' size='md' bg='#18181C' color='#9E9E9E' border={'none'} _placeholder={{ color: '#9E9E9E' }} />
                    </VStack>
                    <HStack pt='44px'>
